        ...
        <div class="container d-flex justify-content-center my-5">
            <form action="userRegister" method="post" id="form" class="w-50 p-4 border rounded">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="username" name="userName" value="${dto.userName}" required>
                    <p class="error text-danger" id="nameError"></p>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" name="email" value="${dto.email}" onblur="checkEmail()" required>
                    <p class="error text-danger" id="emailError"></p>
                </div>
                <div class="mb-3">
                    <label for="phoneNumber" class="form-label">Phone Number</label>
                    <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" value="${dto.phoneNumber}" onblur="phoneNumberCheck()" required>
