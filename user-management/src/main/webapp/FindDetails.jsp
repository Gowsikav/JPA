    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="redirectToFindDetails">Find Details</a>
                </li>
                <li class="nav-item">
...
<h4 class="text-center mb-4">View User Details</h4>
...
<div class="container d-flex justify-content-center my-5">
    <form action="userRegister" method="post" id="form"
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="${dto.dateOfBirth}"
                   required>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="js/findDetailsAjax.js"></script>
</body>
