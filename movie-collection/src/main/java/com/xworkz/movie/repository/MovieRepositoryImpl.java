...
public class MovieRepositoryImpl implements MovieRepository{
    ...
    public Optional<MovieEntity> findByDirectorName(String directorName) {
        ...
        try {
            ...
            movieEntity=(MovieEntity) entityManager.createNamedQuery("directorName").setParameter("name",directorName).getSingleResult();
        }catch (PersistenceException e)
        {
            System.out.println(e.getMessage());
        }finally {
    ...
    public Optional<MovieEntity> findByHeroName(String heroName) {
        ...
        try {
            ...
            movieEntity=(MovieEntity) entityManager.createNamedQuery("heroName").setParameter("name",heroName).getSingleResult();
        }catch (PersistenceException e)
        {
            System.out.println(e.getMessage());
        }finally {
