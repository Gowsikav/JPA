    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="redirectToRegister">Book Register</a>
                </li>
                <li class="nav-item">
...
<h4 class="text-center mb-4">Book Registration Form</h4>

<div class="container d-flex justify-content-center my-5">
    <form action="bookRegister" method="post" id="form"
